...
2026-09-14：產品隔離 checkout `github-notes-study`，基底 core `3481ffd`，本次修正獨立學習頁、status 流轉、單列 navbar 與共用按鈕。
...
| 5. 篩選與互斥排序 | screen-content 核心測試；瀏覽器驗證一般泳道按標題排序、學習頁固定最早到期；篩選網址重載保留 | pass |
...
| 16. 單列 navbar | qa-study 驗證 320／390／820／1440px 所有 navbar 控制同列、44px 高、無多餘標題及排序提示 | pass |
