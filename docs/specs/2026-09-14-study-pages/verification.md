...
2026-09-14：產品隔離 checkout `github-notes-study`，基底 core `e27c9e5`，本次精簡單卡頁面、固定 Page 頁序、底部常用操作與設定篩選。
...
| 9. 手機手勢與控制 | qa-study 原生觸控換頁、揭示前無評分、左右滑動只換頁、320／390px 按鈕尺寸及寬度 | pass |
...
| 16. 單列 navbar | qa-study 驗證 320／390／820／1440px 所有 navbar 控制同列、44px 高、只有返回與設定；320×420 底部操作完整可見且內容高度至少 80px | pass |
