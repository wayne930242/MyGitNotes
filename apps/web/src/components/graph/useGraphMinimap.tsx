...
export function useGraphMinimap({ graphRef: fgRef, graphData, dimensions, isDark, nodeColor, onClearHover, onReset: handleResetZoom, onNavigate }: {
  graphRef: RefObject<ForceGraphMethods<NoteGraphNode, NoteGraphLink> | undefined>;
  graphData: { nodes: NoteGraphNode[]; links: NoteGraphLink[] };
  dimensions: { width: number; height: number };
  isDark: boolean; nodeColor: (node: NoteGraphNode) => string;
  onClearHover: () => void; onReset: () => void; onNavigate: () => void;
}) {
