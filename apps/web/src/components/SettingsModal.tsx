        ...
        <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap sm:flex-nowrap">
          <div>
            <div className="flex items-center gap-2">
              ...
              {branch === 'core' && (
                <span className="text-[11px] px-2 py-0.5 rounded-full bg-warning-soft text-warning font-medium">
          ...
          <div className="text-xs bg-warning-soft/80 border border-warning/80 text-warning rounded-lg p-3 flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-warning">
                ...
                <code className="font-mono bg-warning-soft/70 px-1 py-0.5 rounded text-warning font-semibold">
          ...
          <div
            className={`p-3 rounded-lg text-xs flex items-start gap-2 ${
              coreUpdateMsg.startsWith('Error:')
                ...
                : 'bg-primary-soft text-primary-hover border border-primary'
            }`}
          >
      ...
      <div id="settings-manifest" className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {branch === 'core' && (
              <span className="text-[11px] px-2 py-0.5 rounded-full bg-sidebar text-muted font-mono">
...
>
        ...
        <textarea
          ...
          rows={12}
          className="w-full p-4 font-mono text-xs bg-code text-fg rounded-xl focus:outline-none focus:ring-2 focus:ring-primary leading-relaxed border border-line"
          spellCheck={false}
        />
      ...
      <div className="break-words text-[11px] text-muted border-t border-line pt-3">
        {local ? t('settings.repoRoot') : t('settings.githubSource')}: <code className="text-muted font-mono">{repoRoot}</code>
      </div>
          </div>
        </div>
      </div>
