    ...
    <EditorNotice
      actions={
        <>
          <button
            onClick={onRestore}
            className="flex items-center justify-center gap-1.5 px-3 py-1 bg-warning text-on-warning rounded-md text-xs font-medium hover:bg-warning/90 active:scale-95 transition"
          >
