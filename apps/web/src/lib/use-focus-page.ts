...
const client: WorkspaceDocumentClient<FocusPage> = {
  document: FOCUS_DOCUMENT, endpoint: '/api/focus-page', draftKey: 'focus-draft',
  messages: { load: 'focus.loadError', conflict: 'focus.conflict', limit: 'focus.limit', draft: 'focus.draftError', save: 'focus.saveError', loading: 'focus.loading' },
};
