...
const client: WorkspaceDocumentClient<ScreenPage> = { document: SCREEN_DOCUMENT, endpoint: '/api/screen-page', draftKey: 'screen-draft', messages: { load: 'screen.loadError', conflict: 'screen.conflict', limit: 'screen.limit', draft: 'screen.draftError', save: 'screen.saveError', loading: 'screen.loading' } };
